...
from finbert_sentiment import DEFAULT_FINBERT_MODEL, analyze_financial_sentiment


EVENT_SOURCES_CONFIG_PATH = os.path.join("config", "event_sources.json")
...
def _fetch_from_local_file(source_config: Dict) -> List[MarketEvent]:
    ...
    example_path = str(source_config.get("example_path") or "market_events.example.json")
