...
NEWS_INTELLIGENCE_FILE = str(STATE_DIR / "news_intelligence.json")
FINANCIALS_INTELLIGENCE_FILE = str(STATE_DIR / "financials_intelligence.json")
DECISION_BRIEF_FILE = str(STATE_DIR / "decision_brief.json")
EVENT_SOURCE_STATUS_FILE = str(STATE_DIR / "event_source_status.json")
...
WEEKEND_CORRELATION_RESEARCH_FILE = str(STATE_DIR / "weekend_correlation_research.json")
FINAL_DECISION_SNAPSHOT_FILE = str(STATE_DIR / "final_decision_snapshot.json")
...
FOUNDATION_MODEL_SNAPSHOT_FILE = str(STATE_DIR / "foundation_model_snapshot.json")
FOUNDATION_TRAINING_OBSERVATIONS_FILE = str(STATE_DIR / "foundation_training_observations.parquet")
MARKET_SENTIMENT_SNAPSHOT_FILE = str(STATE_DIR / "market_sentiment_snapshot.json")
SYSTEMIC_RISK_SNAPSHOT_FILE = str(STATE_DIR / "systemic_risk_snapshot.json")
...
FOUNDATION_MODEL_CONFIG_FILE = str(CONFIG_DIR / "foundation_model.json")
FINANCIALS_CONFIG_FILE = str(CONFIG_DIR / "financials_config.json")
